...
Shaping.square = function ( t ){
    return Math.sin( t * PI2 ) > 0 ? 1 : .5;
};

Shaping.sawtooth = function ( t ){
    return ( t - Math.floor( t ) );
};

Shaping.triangle = function ( t ){
    return  ( .5 - Math.abs( t - Math.floor( t + .5 ) ) );
};
...
Shaping.expStep = function (x, k, t) {
    return Math.exp(-k * Math.pow(x, t));
};
